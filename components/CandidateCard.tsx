...
// //         {/* Candidate Image */}
// //         <div className="relative w-full md:h-72 xl:h-72">
// //           <Image
// //             src={image} // e.g., "/assets/images/candidates/1-p.png"
// //             alt={name}
// //             fill
// //             sizes="(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 33vw" // Adjust based on your layout
...
//             alt={name}
//             fill
//             sizes="(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 33vw" // Adjust based on grid
//             className="object-cover rounded-t-2xl"
